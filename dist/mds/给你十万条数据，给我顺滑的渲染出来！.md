...
```
运行可以看到这个数据：
![](http://s4lrouxtt.hn-bkt.clouddn.com/moon/article/listLoad-01.png)
image.png
...
![](http://s4lrouxtt.hn-bkt.clouddn.com/moon/article/listLoad-02.gif)
进度条.gif

但是当我们快速滚动时，页面还是会有**白屏**现象，如下图所示，这是为什么呢？
![](http://s4lrouxtt.hn-bkt.clouddn.com/moon/article/listLoad-03.gif)
st.gif
可以说有两点原因：
...
```
可以看到它白屏时间没有那么长了：
![](http://s4lrouxtt.hn-bkt.clouddn.com/moon/article/640.gif)
rqf.gif

还有没有更好的方案呢？当然有！往下看！
## 4. 虚拟列表
我们可以通过这张图来表示**虚拟列表**，**红框**代表你的**手机**，**黑条**代表**一条条数据**。
![](http://s4lrouxtt.hn-bkt.clouddn.com/moon/article/listLoad-05.png)
...
```
可以看到白屏现象解决了！
![](http://s4lrouxtt.hn-bkt.clouddn.com/moon/article/listLoad-06.gif)
# 结语
